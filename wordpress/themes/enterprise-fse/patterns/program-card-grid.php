...
<div class="wp-block-query alignwide">
	<!-- wp:post-template {"layout":{"type":"grid","minimumColumnWidth":"18rem"}} -->
		<!-- wp:group {"style":{"spacing":{"padding":"var:preset|spacing|40"},"border":{"color":"var:preset|color|line","width":"1px","radius":"var:custom|radius|card"},"dimensions":{"minHeight":"100%"}},"backgroundColor":"surface","layout":{"type":"constrained"}} -->
		<div class="wp-block-group has-surface-background-color has-background" style="border-color:var(--wp--preset--color--line);border-width:1px;border-radius:var(--wp--custom--radius--card);min-height:100%;padding:var(--wp--preset--spacing--40)">
