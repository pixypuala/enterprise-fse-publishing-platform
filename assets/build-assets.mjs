 ...
 * HTML/SVG that uses the identity tokens in source/identity.css, so a palette
 * change is one edit and a rebuild rather than a redraw. Dimensions are exactly
 * what wordpress.org expects, and the shots are taken at deviceScaleFactor 1 so
...
/** Upstream font releases. Both SIL Open Font License 1.1. */
const FONTS = [
  {
    file: 'Newsreader.ttf',
    url: 'https://github.com/google/fonts/raw/main/ofl/newsreader/Newsreader%5Bopsz%2Cwght%5D.ttf',
  },
  {
    file: 'PublicSans.ttf',
    url: 'https://github.com/google/fonts/raw/main/ofl/publicsans/PublicSans%5Bwght%5D.ttf',
  },
];
